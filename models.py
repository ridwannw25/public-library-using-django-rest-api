...
class BorrowBook(models.Model):
    ...
    author = models.TextField()
    publication_date = models.DateField(blank=True, null=True)
    status_borrow = models.TextField(blank=True, null=True)
    status_return = models.TextField(blank=True, null=True)
    borrow_date = models.DateField(blank=True, null=True)
    id_category_id = models.TextField(blank=True, null=True)
    id_status_id = models.TextField(blank=True, null=True)  # This field type is a guess.
